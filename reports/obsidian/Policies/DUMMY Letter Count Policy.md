...
```
Implementation Path (only works if vault is opened at level including the src folder): [../../../src/Implementations/Python/Policies/Dummy.py](../../../src/Implementations/Python/Policies/Dummy.py)
